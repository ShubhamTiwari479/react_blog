        ...
        <div>
            ...
            <div>
                <div className="container">
                    ...
                    {/* BOX - 2 */}
                    <input className="box box2" style={{ width: "800px",marginLeft:"29px", height: "4.6rem" }} type="search" placeholder="search"></input>
                    ...
                    {/* BOX - 5 */}
                    <button className="box box5" style={{
                    ...
                    {/* BOX - 6 */}
                    <button className="box box6" style={{ width: "160px", padding: "18px", marginLeft: "4px", marginRight: "4px", height: "75px" }}>Login</button>
